...
"""
import pytest
from backend.core.resolver.factories.js_factory import JavaScriptParserFactory
...
from backend.core.resolver.parsers.javascript.package_lock_v2 import PackageLockV2Parser
from backend.core.resolver.parsers.javascript.yarn_lock import YarnLockParser
from backend.core.resolver.parsers.javascript.npm_ls import NpmLsParser
from backend.tests.fixtures.package_json_samples import BASIC_PACKAGE_JSON
from backend.tests.fixtures.package_lock_samples import PACKAGE_LOCK_V1, PACKAGE_LOCK_V2
from backend.tests.fixtures.yarn_lock_samples import BASIC_YARN_LOCK
import json
