...
class PythonParserFactory:
    ...
    when available (generated via pip).
    """
    ...
    def detect_best_format(self, available_files: dict[str, str]) -> tuple[str, str]:
        ...
        """
        # Priority order: pip output first, then other lockfiles, then manifests
        priority_order = [
            ("requirements.lock", "requirements"),  # Generated by pip (most accurate)
    ...
    def get_supported_formats(self) -> list[str]:
        ...
        return [
            "requirements.lock",  # pip output (preferred)
            "poetry.lock",
            "Pipfile.lock", 
            "requirements.txt",
            "pyproject.toml",
