...
def main():
    ...
    test_categories = [
        {
            "command": "python -m pytest tests/unit/parsers/ -v",
            "description": "Parser Class Tests"
        },
        {
            "command": "python -m pytest tests/unit/factories/ -v", 
            "description": "Factory Pattern Tests"
        },
        {
            "command": "python -m pytest tests/unit/utils/ -v",
            "description": "Utility Class Tests"
        },
        {
            "command": "python -m pytest tests/unit/test_js_resolver_new.py -v",
            "description": "JavaScript Resolver Tests (New Architecture)"
        },
        {
            "command": "python -m pytest tests/unit/test_python_resolver.py -v",
            "description": "Python Resolver Tests"
        },
        {
            "command": "python -m pytest tests/unit/test_osv_scanner.py -v",
        ...
        {
            "command": "python test_resolvers.py",
